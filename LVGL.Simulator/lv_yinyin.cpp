...
void lv_yinyin::obd2_values_update(ELM327& myELM327) {
    processValue(myELM327, &ELM327::kph, _kph); // KPH
    processValue(myELM327, &ELM327::engineCoolantTemp, _coolantTemp); // Coolant Temp
    processValue(myELM327, &ELM327::rpm, _rpm); // RPM
    processValue(myELM327, &ELM327::batteryVoltage, _voltage); // Voltage
    processValue(myELM327, &ELM327::manifoldPressure, _absolutePressure); // Absolute Pressure
}
...
void lv_yinyin::lv_yinyin_update(ELM327& myELM327) {
    obd2_values_update(myELM327);
